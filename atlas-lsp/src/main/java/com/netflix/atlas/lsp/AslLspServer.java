...
public class AslLspServer implements LanguageServer, LanguageClientAware {
    ...
    private final AslDocumentAnalyzer analyzer;
    ...
    public AslLspServer(Vocabulary vocabulary, Glossary glossary) {
        this.interpreter = Interpreter.apply(
                vocabulary.allWords(),
                Interpreter.defaultMaxStackSize(),
                Interpreter.defaultMaxOperations());
    ...
    public AslDocumentAnalyzer analyzer() {
        return analyzer;
    }
