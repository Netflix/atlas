...
case object SDesSlower extends StackWordPage {
  val vocab: Vocabulary = StatefulVocabulary
  val word: Word = vocab.words.find(_.name == "sdes-slower").get
  ...
  override def summary: String =
    """
      ...
      |[recommended values](DES#recommended-values) for more information.
    """.stripMargin.trim
}
