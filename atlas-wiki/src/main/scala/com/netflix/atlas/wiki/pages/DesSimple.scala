...
case object DesSimple extends StackWordPage {
  val vocab: Vocabulary = StatefulVocabulary
  val word: Word = vocab.words.find(_.name == "des-simple").get
  ...
  override def summary: String =
    """
      ...
      |
      |> :warning: The values used by this operation are prone to wild oscillations. See
      |[recommended values](DES#recommended-values) for better options.
    """.stripMargin.trim
}
