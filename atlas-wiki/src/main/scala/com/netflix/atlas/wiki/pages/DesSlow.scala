...
case object DesSlow extends StackWordPage {
  val vocab: Vocabulary = StatefulVocabulary
  val word: Word = vocab.words.find(_.name == "des-slow").get
  ...
  override def summary: String =
    """
      ...
      |the sliding DES variant [:sdes-fast](stateful-sdes‐slow) should be used instead.
    """.stripMargin.trim
}
