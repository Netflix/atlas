...
```
$ curl -LO https://github.com/Netflix/atlas/releases/download/v1.5.2/atlas-1.5.2-standalone.jar
$ java -jar atlas-1.5.2-standalone.jar
```
...
$ java -jar atlas-1.5.2-standalone.jar memory.conf
```
