...
/**
  * Subclass of [[SubscriptionManager]] that uses actors for the handler. In some cases
  ...
  * that needs an [[ActorRef]].
  */
class ActorSubscriptionManager extends SubscriptionManager[ActorRef]
