...
object Dependencies {
  ...
  val equalsVerifier    = "nl.jqno.equalsverifier" % "equalsverifier" % "3.5.4"
  ...
  val roaringBitmap     = "org.roaringbitmap" % "RoaringBitmap" % "0.9.8"
  val scalaCompat       = "org.scala-lang.modules" %% "scala-collection-compat" % "2.4.1"
